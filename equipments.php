	...
	flipbook.turn({					
			...
			when: {
				...
				missing: function (event, pages) {
                    ...
                    var types= "equipments/equipments-";
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement, types) {
				...
				if (scale==1)
					loadSmallPage(page, pageElement, "equipments/equipments-");
				else
					loadLargePage(page, pageElement, "equipments/equipments-");

	...
	flipbook.turn({					
			...
			when: {
				...
				missing: function (event, pages) {
                    ...
                    var types= "gyno/2.GYNECOLOGICAL-";
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement, types) {
				...
				if (scale==1)
					loadSmallPage(page, pageElement, "gyno/2.GYNECOLOGICAL-");
				else
					loadLargePage(page, pageElement, "gyno/2.GYNECOLOGICAL-");

	...
	flipbook.turn({					
			...
			when: {
				...
				missing: function (event, pages) {
                    ...
                    var types= "cardio/5.CARDIO THORACIC-";
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement, types) {
				...
				if (scale==1)
					loadSmallPage(page, pageElement, "cardio/5.CARDIO THORACIC-");
				else
					loadLargePage(page, pageElement, "cardio/5.CARDIO THORACIC-");

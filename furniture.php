	...
	flipbook.turn({					
			...
			when: {
				...
				missing: function (event, pages) {
                    ...
                    var types= "furniture_catalogue/furniture_catalogue-";
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement, types) {
				...
				if (scale==1)
					loadSmallPage(page, pageElement, "furniture_catalogue/furniture_catalogue-");
				else
					loadLargePage(page, pageElement, "furniture_catalogue/furniture_catalogue-");

                                            ...
                                            <li class="menu-item menu-item-has-children">
                                                ...
                                                <ul class="custom sub-menu">
                                                    <li class="menu-item menu-item-has-children">
                                                        ...
                                                        <ul class="custom sub-menu">
                                                            <li class="menu-item">
                                                                <a href="obs_gynae-surg.php" class="text-light-grey">General OBS & Gynae Surgery Tools</a>
                                                            </li>
                                                            <li class="menu-item">
                                                    ...
                                                    <li class="menu-item">
                                                        <a href="gyno.php" class="text-light-grey">TC Instruments</a></a>
                                                    </li>
                                                    <li class="menu-item">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-8">
                        <iframe class="full-width full-height" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.7602246516594!2d80.09202411430508!3d13.050928616664981!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a528b9bf6d3b5c7%3A0x3ce93ff8da3dcaf0!2sBHN%20SURGICALS%20PRIVATE%20LIMITED!5e0!3m2!1sen!2sin!4v1593700539978!5m2!1sen!2sin"></iframe>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="contact-info bx-wrapper bg-custom-white text-center mb-md-40">
                            <div class="contact-info-wrapper">
                                ...
                                <a href="#" class="fs-14">91-44- 4217 0271</a></br>
                                <a href="#" class="fs-14">98407 69153</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="contact-info bx-wrapper bg-custom-white text-center mb-md-40">
                            <div class="contact-info-wrapper">
                                ...
                                <p class="text-light-white">Start working with BHN</p>
                                <a href="#" class="fs-14">bhnsurgicals@gmail.com</a></br>
                                <a href="#" class="fs-14">links.group@vsnl.net</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="contact-info bx-wrapper bg-custom-white text-center">
                            <div class="contact-info-wrapper">
                                ...
                                <p class="text-light-white">Start working with BHN</p></br>
                                <a href="https://goo.gl/maps/RZDo2cBF3gpyBzp1A" target="_blank" class="fs-14">View on Google map</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 no-padding">
                        <div class="intro-box bg-light-blue full-height">
                            <div class="intro-wrapper text-center">
                                ...
                                <a href="#book-appointment" class="btn-first btn-submit-white fw-600 scrollbtn">Enquiry Form</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table text-custom-white">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Mobile</td>
                                            <td> - </td>
                                            <td class="text-right">98407 69153</td>
                                        </tr>
                                        <tr>
                                            <td>Mobile</td>
                                            <td> - </td>
                                            <td class="text-right">94444 01123</td>
                                        </tr>
                                        <tr>
                                            <td>Mobile</td>
                                            <td> - </td>
                                            <td class="text-right">94451 06688</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p class="text-custom-black">© 2020 BHN surgicals All Rights Reserved</p>
                    </div>
                    <div class="col-md-6">

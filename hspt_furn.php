	...
	$( "#slider" ).slider({
		...
		start: function(event, ui) {
			...
			if (!window._thumbPreview) {
				_thumbPreview = $('<div />', {'class': 'thumbnail'}).php('<div></div>');
				setPreview(ui.value);
...
// Load the.php4 version if there's not CSS transform

yepnope({
	test : Modernizr.csstransforms,
	yep: ['lib/turn.min.js'],
	nope: ['lib/turn.php4.min.js', 'css/jquery.ui.php4.css'],

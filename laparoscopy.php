	...
	flipbook.turn({					
			...
			when: {
				...
				missing: function (event, pages) {
                    ...
                    var types= "laparoscopy_catalogue/laparoscopy_catalogue-";
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement, types) {
				...
				if (scale==1)
					loadSmallPage(page, pageElement, "laparoscopy_catalogue/laparoscopy_catalogue-");
				else
					loadLargePage(page, pageElement, "laparoscopy_catalogue/laparoscopy_catalogue-");

	...
	flipbook.turn({
			...
			when: {
				...
				missing: function (event, pages) {
                    ...
                    var types="gcm/1.GENERAL SURGERY E CATALOGUE new-";
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement) {
				...
				if (scale==1)
					loadSmallPage(page, pageElement, "gcm/1.GENERAL SURGERY E CATALOGUE new-");
				else
					loadLargePage(page, pageElement, "gcm/1.GENERAL SURGERY E CATALOGUE new-");
